...
namespace DataAccessLayer.DTO
{
    public class A2ZSYSIDSDTO
    {
        ...
        public static int InsertNewIdInformation(A2ZSYSIDSDTO objIds)
        {
            ...
            string strQuery = "INSERT INTO A2ZSYSIDS(IdsNo,IdsName,IdsLevel,IdsFlag,EmpCode,UserId,IdsPass,IdsLogInFlag,IdsLockFlag,IdsType,IdsStatus,GLCashCode,UserBranchNo,IdsSODFlag,IdsVPrintFlag,IdsAutoVchFlag)" +
                                "VALUES ('" + objIds.IdsNo + "','" + objIds.IdsName + "','" + objIds.IdsLevel + "','" + objIds.IdsFlag + "','" +
                                objIds.EmpCode + "','" + objIds.UserId + "','XXXXXXXX',0,0,0,0,'" + objIds.GLCashCode + "','" + objIds.UserBranchNo + "','" + objIds.SODflag + "','" + objIds.VPrintflag + "','" + objIds.AutoVchflag + "')";
        ...
        public static int Update(A2ZSYSIDSDTO objIds)
        {
            ...
            string strQuery = "UPDATE A2ZSYSIDS SET IdsLevel='" + objIds.IdsLevel + "',IdsName='" + objIds.IdsName + "',EmpCode='" + objIds.EmpCode + "',IdsFlag='" + objIds.IdsFlag + "', GLCashCode = '" + objIds.GLCashCode + "', IdsSODFlag = '" + objIds.SODflag + "', IdsVPrintFlag = '" + objIds.VPrintflag + "',IdsAutoVchFlag = '" + objIds.AutoVchflag + "' WHERE IdsNo = '" + objIds.IdsNo + "'";
