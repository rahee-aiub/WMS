<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NationalHolidayMaintenance.aspx.cs" Inherits="ATOZWEBWMS.Pages.NationalHolidayMaintenance" %>
...
<body>
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" runat="server">
                ...
                <span class="contact100-form-title">National Holiday Maintenance
                </span>

                <label class="label-input100" for="first-name">Holiday Date</label>

                <div class="wrap-input100 validate-input">
                    <asp:TextBox ID="txtHolDate" runat="server" class="input100" placeholder="Holiday Date" AutoPostBack="true" OnTextChanged="txtHolDate_TextChanged"></asp:TextBox>
                ...
                <div class="wrap-input100 validate-input">
                    <asp:DropDownList ID="ddlHolType" runat="server" class="input100" Height="50px">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
                    </asp:DropDownList>
                    <script type="text/javascript" src="../scripts/chosen.jquery.js"></script>
                    <span class="focus-input100"></span>
                </div>
                <label class="label-input100" for="first-name">Holiday Note:</label>

                <div class="wrap-input100 validate-input">
                    <asp:TextBox ID="txtHolNote" runat="server" class="input100" placeholder="Party name"></asp:TextBox>
                    <span class="focus-input100"></span>
                </div>
    ...
    <asp:Label ID="lblDayName" runat="server" Visible="False"></asp:Label>
    <asp:Label ID="lblHolTypeDesc" runat="server" Visible="False"></asp:Label>
