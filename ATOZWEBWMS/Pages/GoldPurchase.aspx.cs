...
{
    public partial class GoldPurchase : System.Web.UI.Page
    {
        ...
        {
            string sqlquery = "SELECT DISTINCT PartyCode,PartyName from A2ZPARTYCODE WHERE GroupCode = 12 AND PartyPurchaseCode='" + ddlPurchasePartyName.SelectedValue + "' GROUP BY PartyCode,PartyName ORDER BY PartyName ASC ";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlPurchasePartyName.SelectedIndex == 0)
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Select Purchase Party');", true);
                    return;
                }
                ...
                CtrlVoucherNo.Text = "GP" + getDTO.RecLastNo.ToString("000000");
        ...
        protected void BtnAddItem_Click(object sender, EventArgs e)
        {
            if (ddlPurchasePartyName.SelectedIndex == 0)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Select Purchase Code');", true);
                return;
            }
            ...
            try
            {
                ...
                prm[1] = ddlPurchasePartyName.SelectedValue; // TrnKeyNo
                prm[2] = ddlCode.SelectedValue; // RefTrnKeyNo
                prm[3] = ddlKarat.SelectedValue; // AccKarat
                prm[4] = "1";  // Location
                prm[5] = "1"; // FuncOpt
                prm[6] = "Gold Purchase"; //FuncOptDesc
                prm[7] = "0"; // PayType
                prm[8] = "1"; // TrnType
                prm[9] = "0"; // TrnDrCr  
                ...
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("[Sp_InsertWfGoldPurchase]", prm, "A2ZACWMS"));
        ...
        protected void gvItemDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                sqlQuery = @"DELETE  FROM WFA2ZTRANSACTION WHERE  Id = '" + NId + "'";
                rowEffect = Converter.GetInteger(DataAccessLayer.BLL.CommonManager.Instance.ExecuteNonQuery(sqlQuery, "A2ZACWMS"));
        ...
        protected void ddlPurchasePartyName_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            string qry2 = "SELECT SUM(TrnAmount) AS TrnAmount FROM WFA2ZTRANSACTION WHERE VchNo IS NULL AND AccType = 14 AND TrnFlag = 0" +
