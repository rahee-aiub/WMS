<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoldReceive.aspx.cs" Inherits="ATOZWEBWMS.Pages.GoldReceive" %>
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" runat="server">
                ...
                <span class="contact100-form-title">Gold Receive
                </span>
                ...
                <div class="wrap-input100 validate-input">
                    <asp:DropDownList ID="ddlTransitPartyName" runat="server" class="input100" Height="50px" AutoPostBack="True" OnSelectedIndexChanged="ddlTransitPartyName_SelectedIndexChanged">
                            ...
                            <asp:GridView ID="gvDetails" runat="server" HeaderStyle-BackColor="YellowGreen"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Karat" HeaderStyle-Width="90px" ItemStyle-Width="90px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="Center">
                                       ...
                                       <asp:BoundField DataField="TrnAmount" HeaderText="GrossWt" Visible="false">
                                        <HeaderStyle Width="150px" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="150px" />
                                    </asp:BoundField>
