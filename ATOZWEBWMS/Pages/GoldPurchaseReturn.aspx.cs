...
{
    public partial class GoldPurchaseReturn : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CtrlVoucherNo.Text = "GPR" + getDTO.RecLastNo.ToString("000000");
        ...
        protected void BtnAddItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                prm[4] = "1";  // Location
                prm[5] = "2"; // FuncOpt
                prm[6] = "Gold Purchase Return"; //FuncOptDesc
                prm[7] = "0"; // PayType
                prm[8] = "1"; // TrnType
                prm[9] = "1"; // TrnDrCr  
        ...
        {
            string qry2 = "SELECT SUM(TrnAmount) AS TrnAmount FROM WFA2ZTRANSACTION WHERE TrnKeyNo = '" + ddlPurchasePartyName.SelectedValue + "'";
