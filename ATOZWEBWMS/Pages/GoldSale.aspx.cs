...
{
    public partial class GoldSale : System.Web.UI.Page
    {
        ...
        {
            string sqlquery = "SELECT A2ZACCOUNT.AccNo,A2ZPARTYCODE.PartyName FROM A2ZACCOUNT inner join A2ZPARTYCODE on A2ZPARTYCODE.PartyCode=A2ZACCOUNT.AccPartyNo Where AccType = 12 AND AccLocation = 3 AND AccBalance > 0";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CtrlVoucherNo.Text = "GS" + getDTO.RecLastNo.ToString("000000");
        ...
        {
            string sqlquery = "SELECT A2ZACCOUNT.Id,A2ZPARTYCODE.PartyName,A2ZACCOUNT.AccKarat,A2ZACCOUNT.AccBalance FROM A2ZACCOUNT inner join A2ZPARTYCODE on A2ZPARTYCODE.PartyCode=A2ZACCOUNT.AccPartyNo Where AccType = 12 AND AccLocation = 3 AND AccBalance > 0";
        ...
        {
            string qry = "SELECT AccBalance FROM A2ZACCOUNT WHERE AccLocation = 3 AND AccType = 12 AND AccNo = " + ddlCode.SelectedValue + " AND AccKarat = " + ddlKarat.SelectedValue + "";
