<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpenNewParty.aspx.cs" Inherits="ATOZWEBWMS.Pages.OpenNewParty" %>
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" runat="server">
                ...
                <span class="contact100-form-title">New Party Open
                </span>
                ...
                <label class="label-input100" for="first-name">Party Name</label>

                <div class="wrap-input100 validate-input">
                    <asp:TextBox ID="txtPartyName" runat="server" class="input100" MaxLength="100" placeholder="Party name"></asp:TextBox>
                    <span class="focus-input100"></span>
                </div>

                <label ID="lblAddress" runat="server" class="label-input100" for="email">Party Address</label>
                <div ID="DivAddress" runat="server" class="wrap-input100 validate-input">
                    <asp:TextBox ID="txtPartyAddress" runat="server" class="input100" placeholder="House#,Road#,City"></asp:TextBox>
                    <span class="focus-input100"></span>
                </div>

                <label ID="lblPhone" runat="server" class="label-input100" for="phone">Phone Number</label>
                <div ID="DivPhone" runat="server" class="wrap-input100">
                    <asp:TextBox ID="txtPartyPhone" runat="server" class="input100" placeholder="Eg. +8801700000000"></asp:TextBox>
                    <span class="focus-input100"></span>
                </div>

                <label ID="lblEmail" runat="server" class="label-input100" for="email">Party Email</label>
                <div ID="DivEmail" runat="server" class="wrap-input100 validate-input">
                ...
                <div class="container-contact100-form-btn ">
                    ...
                    <div class="rs1">
                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="contact100-form-btn green" OnClientClick="if(this.value === 'Submit...') { return false; } else { this.value = 'Submit...'; }" OnClick="btnSubmit_Click"></asp:Button>
                        </div>
