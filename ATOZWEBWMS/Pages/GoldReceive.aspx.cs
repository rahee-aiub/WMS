...
{
    public partial class GoldReceive : System.Web.UI.Page
    {
        ...
        {
            string sqlquery = "SELECT A2ZPARTYCODE.PartyCode,A2ZPARTYCODE.PartyName FROM A2ZACCOUNT inner join A2ZPARTYCODE on A2ZPARTYCODE.PartyCode=A2ZACCOUNT.AccTrackingCode Where AccPartyNo = '" + ddlTransitPartyName.SelectedValue + "' AND AccType = 13 AND AccLocation = 2 AND AccBalance > 0";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CtrlVoucherNo.Text = "GR" + getDTO.RecLastNo.ToString("000000");
        ...
        protected void BtnAddItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                prm[4] = "2";  // Location
                prm[5] = "21"; // FuncOpt
                prm[6] = "Gold Receive"; //FuncOptDesc
                prm[7] = "0"; // PayType
                prm[8] = "1"; // TrnType
                prm[9] = "0"; // TrnDrCr  
                ...
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("[Sp_InsertWfGoldReceive]", prm, "A2ZACWMS"));
        ...
        protected void gvItemDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                gvDetails_RowDataBound(null, null);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        protected void btnWtBalance_Click(object sender, EventArgs e)
        {
            ...
            if (ddlTransitPartyName.SelectedIndex == 0)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Select Party Name');", true);
                return;
            }
        ...
        {
            string sqlquery = "SELECT A2ZACCOUNT.Id,A2ZPARTYCODE.PartyName,A2ZACCOUNT.AccKarat,A2ZACCOUNT.AccBalance FROM A2ZACCOUNT inner join A2ZPARTYCODE on A2ZPARTYCODE.PartyCode=A2ZACCOUNT.AccTrackingCode Where AccPartyNo = '" + ddlTransitPartyName.SelectedValue + "' AND AccType = 13 AND AccLocation = 2 AND AccBalance > 0";
        ...
        {
            string qry = "SELECT AccBalance FROM A2ZACCOUNT Where AccPartyNo = '" + ddlTransitPartyName.SelectedValue + "' AND AccTrackingCode = '" + ddlCode.SelectedValue + "' AND AccType = 13 AND AccLocation = 2 AND AccKarat = " + ddlKarat.SelectedValue + "";
        ...
        protected void ddlTransitPartyName_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlTransitPartyName.SelectedIndex != 0)
            {
        ...
        {
            string qry2 = "SELECT SUM(TrnAmount) AS TrnAmount FROM WFA2ZTRANSACTION WHERE VchNo IS NULL AND AccType = 12 AND TrnDrCr = 0" +
            " AND UserId = '" + lblID.Text + "'";
