<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoldPurchase.aspx.cs" Inherits="ATOZWEBWMS.Pages.GoldPurchase" %>
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" runat="server">
                ...
                <span class="contact100-form-title">Gold Purchase
                </span>
                ...
                <div class="wrap-input100 validate-input">
                    <asp:DropDownList ID="ddlPurchasePartyName" runat="server" class="input100" Height="50px" AutoPostBack="true" OnSelectedIndexChanged="ddlPurchasePartyName_SelectedIndexChanged">
                    ...
                    <asp:Panel ID="pnlProperty" runat="server" Height="320px">
                        <table class="style1">
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:TextBox ID="txtGrossWt" runat="server" TabIndex="2" Width="150px" Height="30px" Style="text-align: Right" Font-Size="Small" BorderColor="#1293D1" BorderStyle="Ridge" onkeypress="return IsDecimalKey(event)"
                        ...
                        <div align="center" class="grid_scroll">
                            <asp:GridView ID="gvDetails" runat="server" HeaderStyle-BackColor="YellowGreen"
                                AutoGenerateColumns="False" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px" EnableModelValidation="True" OnRowDeleting="gvItemDetails_RowDeleting">
