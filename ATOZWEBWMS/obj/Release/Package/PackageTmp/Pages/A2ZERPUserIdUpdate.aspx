<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A2ZERPUserIdUpdate.aspx.cs" Inherits="ATOZWEBWMS.Pages.A2ZERPUserIdUpdate" %>
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" runat="server">
                ...
                <span class="contact100-form-title">Update User Id.
                </span>
                ...
                <div class="wrap-input100 validate-input">
                   <asp:CheckBox ID="ChkWSmoduleflag" runat="server" Font-Size="Large" ForeColor="Red" />
                    <span class="focus-input100"></span>
                </div>
