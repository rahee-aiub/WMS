<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveReports.aspx.cs" Inherits="ATOZWEBWMS.Pages.ReceiveReports" %>

<!DOCTYPE html>
<html lang="en">
<head>
	<title>Receive Statement</title>
	<meta charset="UTF-8">
			...
			<form class="contact100-form validate-form" runat="server">
				...
				<div class="wrap-input100 validate-input">
					  <asp:DropDownList ID="ddlReports" runat="server" class="input100" Height="50px"  >
                        ...
                        <asp:ListItem Value="1">Receive Details Reports</asp:ListItem>
                        <asp:ListItem Value="2">Receive Cancel Reports</asp:ListItem>
                        <asp:ListItem Value="3">Receive Pendig Report</asp:ListItem>
                    </asp:DropDownList>
