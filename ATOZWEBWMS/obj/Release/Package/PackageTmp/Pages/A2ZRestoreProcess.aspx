<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A2ZRestoreProcess.aspx.cs" Inherits="ATOZWEBWMS.Pages.A2ZRestoreProcess" %>
...
<body>
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
                ...
                <span class="contact100-form-title">Restore Process
                </span>
                ...
                <div class="container-contact100-form-btn ">
                    ...
                    <div class="rs1">
                        <asp:Button ID="btnRestore" runat="server" Text="Restore" class="contact100-form-btn green" OnClick="btnRestore_Click"></asp:Button>
                    </div>
                    &nbsp&nbsp&nbsp&nbsp&nbsp
                    <div class="rs1">
     ...
     <div id="divRestore" runat="server" class="grid_scroll">
    ...
    <asp:Label ID="RestoreFlag" runat="server" Visible="False"></asp:Label>
