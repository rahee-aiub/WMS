<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoldSaleReturn.aspx.cs" Inherits="ATOZWEBWMS.Pages.GoldSaleReturn" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            ...
            $("#<%= ddlSalePartyName.ClientID %>").chosen();
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" runat="server">
                ...
                <span class="contact100-form-title">Gold Sale Return
                </span>


                <label class="label-input100" for="first-name">Sale Party Name</label>

                <div class="wrap-input100 validate-input">
                    <asp:DropDownList ID="ddlSalePartyName" runat="server" class="input100" Height="50px">
