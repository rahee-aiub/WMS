...
/****** Object:  StoredProcedure [dbo].[SpM_GenerateAccountOpBalancePrevious]    Script Date: 01/12/2019 12:52:10 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[SpM_GenerateAccountOpBalancePrevious] (@fDate VARCHAR(10))
AS
/*
EXECUTE SpM_GenerateAccountOpBalancePrevious'2019-01-02'
