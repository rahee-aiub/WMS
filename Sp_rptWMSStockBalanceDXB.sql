...
/****** Object:  StoredProcedure [dbo].[Sp_rptWMSStockBalanceDXB]    Script Date: 01/12/2019 11:32:38 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE  [dbo].[Sp_rptWMSStockBalanceDXB] (@tDate VARCHAR(10))
AS
BEGIN
...
/* 
 ...
 EXECUTE Sp_rptWMSStockBalanceDXB '2019-01-01'
