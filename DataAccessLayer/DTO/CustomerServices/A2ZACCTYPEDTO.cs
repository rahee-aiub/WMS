   ...
   public class A2ZACCTYPEDTO
    {
       ...
       public int AccSuretyGLCode { set; get; }
        ...
        public static A2ZACCTYPEDTO GetInformation(int Typecode)
        {
            ...
            DataTable dt = BLL.CommonManager.Instance.GetDataTableBySpWithParams("Sp_GetInfoAccType", prm, "A2ZACWMS");
        ...
        public static A2ZACCTYPEDTO GetOldInformation(int Typecode)
        {
            ...
            DataTable dt = BLL.CommonManager.Instance.GetDataTableByQuery("SELECT * FROM A2ZACCTYPE WHERE OldAccType = " + Typecode, "A2ZACWMS");
