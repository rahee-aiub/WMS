...
namespace DataAccessLayer.DTO.CustomerServices
{
    public class A2ZTRNCTRLDTO
    {
        ...
        public static A2ZTRNCTRLDTO GetInformation(int FuncOpt, int TranCode, int paytype, int trntype, int TranMode)
        {
            ...
            DataTable dt = BLL.CommonManager.Instance.GetDataTableBySpWithParams("Sp_CSGetInfoTrnCtrl", prm, "A2ZACWMS");
        ...
        public static int UpdateInformation01(A2ZTRNCTRLDTO dto)
        {
            ...
            if (dto.TranLogic == 0)
            {
                ...
                int rowEffect3 = Converter.GetInteger(DataAccessLayer.BLL.CommonManager.Instance.ExecuteNonQuery(PropertyQry, "A2ZACWMS"));
            }
            else
            {
